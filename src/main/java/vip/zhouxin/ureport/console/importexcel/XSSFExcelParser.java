 ...
 * the License.
 ******************************************************************************/
package vip.zhouxin.ureport.console.importexcel;
...
import vip.zhouxin.ureport.core.definition.PagingMode;
import vip.zhouxin.ureport.core.definition.Paper;
import vip.zhouxin.ureport.core.definition.PaperSize;
...
public class XSSFExcelParser extends ExcelParser {
	...
	private CellStyle buildCellStyle(XSSFCell cell,XSSFWorkbook book){
		...
		if(!borderStyle.equals(BorderStyle.NONE)){
			...
			border.setStyle(vip.zhouxin.ureport.core.definition.BorderStyle.solid);
			border.setWidth(1);
