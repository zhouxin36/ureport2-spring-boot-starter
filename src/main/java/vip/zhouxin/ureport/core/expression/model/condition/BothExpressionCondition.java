...
public class BothExpressionCondition extends BaseCondition {
	...
	@Override
	protected void afterLeft() {
		setLeftExpression(ExpressionUtils.parseExpression(getLeft()));
	}

	@Override
	protected void afterRight() {
		setRightExpression(ExpressionUtils.parseExpression(getRight()));
	}
