...
import vip.zhouxin.ureport.core.build.cell.CellBuilder;
import vip.zhouxin.ureport.core.build.cell.NoneExpandBuilder;
import vip.zhouxin.ureport.core.build.cell.down.DownExpandBuilder;
import vip.zhouxin.ureport.core.build.cell.right.RightExpandBuilder;
import vip.zhouxin.ureport.core.build.paging.BasePagination;
import vip.zhouxin.ureport.core.build.paging.Page;
import vip.zhouxin.ureport.core.build.paging.PagingBuilder;
import vip.zhouxin.ureport.core.definition.*;
import vip.zhouxin.ureport.core.definition.datasource.*;
...
public class ReportBuilder extends BasePagination implements ApplicationContextAware{
	...
	public ReportBuilder(HideRowColumnBuilder hideRowColumnBuilder) {
		this();
