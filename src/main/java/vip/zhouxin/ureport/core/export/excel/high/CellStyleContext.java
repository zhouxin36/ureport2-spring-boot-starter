 ...
 * the License.
 ******************************************************************************/
package vip.zhouxin.ureport.core.export.excel.high;
...
import vip.zhouxin.ureport.core.definition.Border;
...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border){
		if(border.getStyle().equals(vip.zhouxin.ureport.core.definition.BorderStyle.solid)){
			return BorderStyle.THIN;
		}else if(border.getStyle().equals(vip.zhouxin.ureport.core.definition.BorderStyle.dashed)){
			return BorderStyle.DASHED;
		}else if(border.getStyle().equals(vip.zhouxin.ureport.core.definition.BorderStyle.doublesolid)){
