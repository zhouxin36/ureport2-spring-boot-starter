 ...
 * the License.
 ******************************************************************************/
package vip.zhouxin.ureport.core.export.excel.low;
...
import vip.zhouxin.ureport.core.definition.PaperType;
				...
				for(Page page:pages){
					...
					for(Row r:rows){
			        	...
			        	for(int i=0;i<columnSize;i++){
			        		...
			        		vip.zhouxin.ureport.core.model.Cell cellInfo=colCell.get(col);
			        		if(cellInfo==null){
			        			continue;
			        		}
			        		...
			        		if(obj!=null){
				        		if(obj instanceof String || obj instanceof Number){
				        			...
				        			try{
				        				...
				        				anchor.setDx1(0 * ExcelConstant.EMU_PER_PIXEL);
				        				anchor.setDx2(width * ExcelConstant.EMU_PER_PIXEL);
				        				anchor.setDy1(0 * ExcelConstant.EMU_PER_PIXEL);
