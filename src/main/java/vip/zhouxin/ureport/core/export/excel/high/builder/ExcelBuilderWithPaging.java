 ...
 * the License.
 ******************************************************************************/
package vip.zhouxin.ureport.core.export.excel.high.builder;
...
import vip.zhouxin.ureport.core.export.excel.ExcelConstant;
import vip.zhouxin.ureport.core.export.excel.high.CellStyleContext;
import vip.zhouxin.ureport.core.model.Column;
import vip.zhouxin.ureport.core.model.Image;
...
import vip.zhouxin.ureport.core.utils.ImageUtils;
...
public class ExcelBuilderWithPaging extends ExcelBuilder {
	...
	public void build(Report report, OutputStream outputStream, boolean withSheet) {
		...
		try{
			...
			Map<Row,Map<Column, vip.zhouxin.ureport.core.model.Cell>> cellMap=report.getRowColCellMap();
			...
			for(Page page:pages){
				...
				for(int rowIndex=0;rowIndex<rows.size();rowIndex++){
		        	...
		        	Map<Column, vip.zhouxin.ureport.core.model.Cell> colCell=cellMap.get(r);
		        	int skipCol=0;
		        	for(int i=0;i<columnSize;i++){
		        		...
		        		vip.zhouxin.ureport.core.model.Cell cellInfo=null;
		        		if(colCell!=null){
		        		...
		        		if(obj!=null){
			        		if(obj instanceof String || obj instanceof Number){
			        			...
			        			try{
			        				...
			        				anchor.setDx1(leftMargin * ExcelConstant.EMU_PER_PIXEL);
			        				anchor.setDx2(width * ExcelConstant.EMU_PER_PIXEL);
			        				anchor.setDy1(topMargin * ExcelConstant.EMU_PER_PIXEL);
			        				anchor.setDy2(height * ExcelConstant.EMU_PER_PIXEL);
								...
								cell.setCellValue(new SimpleDateFormat(DateUtils.STANDARD_DATE_FORMAT).format((Date)obj));
			        		}
		        		}
		        	}
