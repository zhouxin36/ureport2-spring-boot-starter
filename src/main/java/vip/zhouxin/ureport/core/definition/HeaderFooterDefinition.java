...
public class HeaderFooterDefinition implements Serializable{
	...
	public void setLeft(String left) {
		this.left = left;
		if(StringUtils.isNotBlank(getLeft())){
			Expression expr= ExpressionUtils.parseExpression(getLeft());
	...
	public void setCenter(String center) {
		this.center = center;
		if(StringUtils.isNotBlank(getCenter())){
			Expression expr= ExpressionUtils.parseExpression(getCenter());
			setCenterExpression(expr);
		}
	}
	...
	public void setRight(String right) {
		this.right = right;
		if(StringUtils.isNotBlank(getRight())){
			Expression expr= ExpressionUtils.parseExpression(getRight());
