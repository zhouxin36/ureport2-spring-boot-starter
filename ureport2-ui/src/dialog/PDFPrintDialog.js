 ...
 */
import {buildPageSizeList, hideLoading, mmToPoint, pointToMM, showLoading} from '../Utils.js';
...
export default class PDFPrintDialog{
    ...
    initBody(){
        ...
        button.click(function(){
            showLoading();
            body['paper']=_this.paper;
            $.ajax({
                url:window._server+'/pdf/newPaging',
                type:'POST',
                contentType: 'application/json',
                data:JSON.stringify(body),
                success:function(){
                    const newUrl=window._server+'/pdf/show'+buildLocationSearchParameters()+'&_r='+(index++);
