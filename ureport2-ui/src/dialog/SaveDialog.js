 ...
 */
import {formatDate, resetDirty, tableToJson} from '../Utils.js';
...
export default class SaveDialog{
    ...
    initFooter(footer){
        ...
        saveButton.click(function(){
            ...
            fileName=_this.currentProviderPrefix+fileName+".ureport.json";
            $.ajax({
                url:window._server+"/designer/saveReportFile",
                data:JSON.stringify(tableToJson(fileName,_this.context)),
                type:'POST',
                contentType: 'application/json',
                success:function(){
                    window._reportFile=decodeURIComponent(fileName);
